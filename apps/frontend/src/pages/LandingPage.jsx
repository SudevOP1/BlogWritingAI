...
const LandingPage = () => {
  return (
    <div className="flex flex-col items-center w-full">
      {/* Hero Section */}
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-8 w-full border-b border-slate-800/50 bg-gradient-to-b from-background to-surface/20">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-row items-center justify-center gap-4 pt-4">
            <Link to="/create-blog">
              <Button size="lg" variant="primary" className="w-full text-sm md:text-base sm:w-auto group">
                Start Generating
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            <Link to="/feed">
              <Button size="lg" variant="outline" className="w-full text-sm md:text-base sm:w-auto group">
                Explore Feed
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
